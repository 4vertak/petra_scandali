...
void def_sub_matrix_test(matrix_t *A, matrix_t *B, matrix_t *C, int rows_A,
  ...
  int return_value = s21_sub_matrix(A, B, C);
#ifdef DEBAG
  print_matrix(A);
  printf("-------------\n");
  print_matrix(B);
...
START_TEST(test_sub_matrix_1) {
  ...
  def_sub_matrix_test(&A, &B, &C, rows_A, columns_A, rows_B, columns_B, value_1,
...
START_TEST(test_sub_matrix_3) {
  ...
  def_sub_matrix_test(&A, NULL, &C, rows_A, columns_A, rows_B, columns_B,
...
START_TEST(test_sub_matrix_5) {
  ...
  double value_2 = 1.0e-7;
  int check_return_value = S21_MATRIX_INCORRECT_MATRIX;
  def_sub_matrix_test(NULL, &B, &C, rows_A, columns_A, rows_B, columns_B,
                      value_1, value_2, check_return_value);
}
END_TEST
...
START_TEST(test_sub_matrix_6) {
  ...
  double value_2 = 1.0e-7;
  int check_return_value = S21_MATRIX_INCORRECT_MATRIX;
  def_sub_matrix_test(NULL, NULL, &C, rows_A, columns_A, rows_B, columns_B,
                      value_1, value_2, check_return_value);
}
END_TEST
...
Suite *test_sub_matrix(void) {
  Suite *s =
      suite_create("\n\033[37;1m==========| S21_SUB_MATRIX |=========\033[0m");
  ...
  tcase_add_test(tc, test_sub_matrix_11);
  tcase_add_test(tc, test_sub_matrix_12);
  tcase_add_test(tc, test_sub_matrix_13);
  tcase_add_test(tc, test_sub_matrix_14);
  tcase_add_test(tc, test_sub_matrix_15);
