...
#ifdef DEBAG
    if (test_v[i] - data.vertex[i] < 0.000001) printf(GREEN "test_rotation\n%f == %f\n", test_v[i], data.vertex[i]);
    else  printf(RED "test_rotation\n%f == %f\n", test_v[i], data.vertex[i]);
#endif
...
START_TEST(test_rotation_01) {
  char file_name[] =
      "/mnt/c/S21/C2/petra_scandali/C8_3DViewer_v1.0/src/tests/test_object.obj";
  data_t data = {0};
  double test_v[] = {-0.500000, 0.500000, -0.500000, -0.500000, -0.500000, -0.500000, -0.500000, 0.500000, 0.500000, -0.500000, -0.500000, 0.500000,
