...
## Part 1. Установка ОС  
![Cкриншот с выводом команды](./img/part1.png){:width="50px"}   

## Part 2. Создание пользователя  
- ![Скриншот вызова команды для создания пользователя](./img/part2.1.png)   
- ![Скриншот с выводом команды.](./img/part2.2.png)   

## Part 3. Настройка сети ОС
##### ![Скриншот установки названия машины вида user-1](./img/part3.1.png)
##### ![Скриншот установки временной зоны, соответствующую текущему местоположению](./img/part3.2.png)
##### ![Вывод названия сетевых интерфейсов с помощью консольной команды.](./img/part3.3.png)
...
##### ![Скриншот использование команд, для получения ip адреса устройства от DHCP сервера](./img/part3.4.png)
...
##### ![Скриншот - внешний ip-адрес шлюза (ip) и внутренний IP-адрес шлюза, он же ip-адрес по умолчанию (gw)](./img/part3.5.png)
...
![Скриншот - заданных настроек](./img/part3.6.png)
##### ![Скриншот после перезагрузки - sudo reboot, статичные сетевые настройки (ip, gw, dns) соответствуют заданным в предыдущем пункте](./img/part3.7.png) 
